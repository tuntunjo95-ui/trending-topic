...
const reports = [
  {
    ...
    countries: [
      country("id", "印尼", "Indonesia", "https://trends24.in/indonesia/", [
        ...
        t("#FavoriteA37A57", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "FavoriteA37A57"),
        t("#SemuaBeraniAwesome", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "SemuaBeraniAwesome"),
        t("#GalaxyA37", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "GalaxyA37"),
        ...
        t("#JusufKalla", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "JusufKalla"),
        t("Neymar", "综合/待分类", "General / To Classify", "低", "Low", "Neymar"),
        t("Trade $GENIUS", "金融/加密（谨慎）", "Finance / Crypto (Watch)", "投机/币圈/广告风险", "Speculation / Crypto-Shill Risk", "Trade $GENIUS"),
        t("Pagii", "综合/待分类", "General / To Classify", "低", "Low", "Pagii"),
        ...
        t("prabowo jaga ketahanan pangan", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "prabowo jaga ketahanan pangan"),
        t("NANI 1ST PRESENT MANDALORIAN", "综合/待分类", "General / To Classify", "低", "Low", "NANI 1ST PRESENT MANDALORIAN"),
        t("2 DAYSTIL GUINZLY BD", "综合/待分类", "General / To Classify", "低", "Low", "2 DAYSTIL GUINZLY BD"),
        t("adudomba pesta babi", "综合/待分类", "General / To Classify", "低", "Low", "adudomba pesta babi")
      ]),
      country("th", "泰国", "Thailand", "https://trends24.in/thailand/", [
        t("#mcคมชัดเละ", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "mcคมชัดเละ"),
        ...
        t("#MoonshadowSeriesQ1", "剧集/综艺/娱乐", "Drama / Variety / Entertainment", "低", "Low", "MoonshadowSeriesQ1"),
        ...
        t("FREE SOUL CHARLOTTE19", "综合/待分类", "General / To Classify", "低", "Low", "FREE SOUL CHARLOTTE19"),
        t("CONGRATS OOMBAM BA OSM", "综合/待分类", "General / To Classify", "低", "Low", "CONGRATS OOMBAM BA OSM"),
        t("3Y2M MEENBABE", "体育/赛事", "Sports / Event", "低", "Low", "3Y2M MEENBABE"),
        t("GEMINIFOURTH NEW TRAILER", "综合/待分类", "General / To Classify", "低", "Low", "GEMINIFOURTH NEW TRAILER"),
        t("KENG HARIT IN AMI PARIS", "综合/待分类", "General / To Classify", "低", "Low", "KENG HARIT IN AMI PARIS"),
      ...
      country("ph", "菲律宾", "Philippines", "https://trends24.in/philippines/", [
        ...
        t("NEW WAV VISUAL PHOTO", "综合/待分类", "General / To Classify", "低", "Low", "NEW WAV VISUAL PHOTO"),
        t("#TREASURE_NEW_WAV_D13", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "TREASURE_NEW_WAV_D13"),
        t("APASRA XAGA AWARDS", "颁奖礼/红毯/盛典", "Awards / Red Carpet / Ceremony", "低", "Low", "APASRA XAGA AWARDS"),
        ...
        t("Dylan Harper", "综合/待分类", "General / To Classify", "低", "Low", "Dylan Harper"),
        t("Walo Hanggang Dulo", "综合/待分类", "General / To Classify", "低", "Low", "Walo Hanggang Dulo"),
        ...
        t("EST SUPHA BD 2026", "综合/待分类", "General / To Classify", "低", "Low", "EST SUPHA BD 2026"),
        t("JENNIE FOR VASELINE", "综合/待分类", "General / To Classify", "低", "Low", "JENNIE FOR VASELINE"),
        t("Wemby", "综合/待分类", "General / To Classify", "低", "Low", "Wemby"),
        t("4SHOVILLE OUT NOW", "音乐/演出/发布", "Music / Show / Release", "低", "Low", "4SHOVILLE OUT NOW"),
        t("martsari close to you", "综合/待分类", "General / To Classify", "低", "Low", "martsari close to you"),
        t("Caruso", "综合/待分类", "General / To Classify", "低", "Low", "Caruso"),
      ...
      country("sa", "沙特", "Saudi Arabia", "https://trends24.in/saudi-arabia/", [
        ...
        t("عرض جميل", "综合/待分类", "General / To Classify", "低", "Low", "عرض جميل")
      ]),
      country("tr", "土耳其", "Turkey", "https://trends24.in/turkey/", [
        t("#19Mayıs", "话题标签/待分类", "Hashtag / To Classify", "低", "Low", "19Mayıs"),
        t("YarenSeniBulacaz", "综合/待分类", "General / To Classify", "低", "Low", "YarenSeniBulacaz"),
        ...
        t("eşin group", "综合/待分类", "General / To Classify", "低", "Low", "eşin group"),
        t("Şenol Güneş", "综合/待分类", "General / To Classify", "低", "Low", "Şenol Güneş"),
        t("Mersin&#39;in Tarsus", "综合/待分类", "General / To Classify", "低", "Low", "Mersin&#39;in Tarsus"),
        t("Graf", "综合/待分类", "General / To Classify", "低", "Low", "Graf"),
        t("Çağlar", "综合/待分类", "General / To Classify", "低", "Low", "Çağlar"),
        t("Orman Benim", "综合/待分类", "General / To Classify", "低", "Low", "Orman Benim"),
        t("minasyazgirdc", "综合/待分类", "General / To Classify", "低", "Low", "minasyazgirdc"),
        t("Kaan Ayhan", "综合/待分类", "General / To Classify", "低", "Low", "Kaan Ayhan"),
        t("Conte", "综合/待分类", "General / To Classify", "低", "Low", "Conte"),
        t("Berke", "综合/待分类", "General / To Classify", "低", "Low", "Berke"),
        t("Önder Özen", "综合/待分类", "General / To Classify", "低", "Low", "Önder Özen"),
        ...
        t("2023 eylül", "综合/待分类", "General / To Classify", "低", "Low", "2023 eylül")
      ]),
      country("vn", "越南", "Vietnam", "https://trends24.in/vietnam/", [
        ...
        t("Wandering", "综合/待分类", "General / To Classify", "低", "Low", "Wandering"),
        ...
        t("Sáng", "综合/待分类", "General / To Classify", "低", "Low", "Sáng"),
        t("Delayed", "综合/待分类", "General / To Classify", "低", "Low", "Delayed"),
