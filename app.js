...
const reports = [
  {
    ...
    countries: [
      ...
      country("th", "泰国", "Thailand", "https://trends24.in/thailand/", [
        ...
        t("#dek69", "综合/待分类", "General / To Classify", "低", "Low", "dek69", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#นุนิวปักใจ6โมงเย็น", "综合/待分类", "General / To Classify", "低", "Low", "นุนิวปักใจ6โมงเย็น", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#KCLmcคิดได้หรือยัง", "综合/待分类", "General / To Classify", "低", "Low", "KCLmcคิดได้หรือยัง", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        ...
        t("#เฮียตี๋5แสนแล้วนะหม่ามี๊", "综合/待分类", "General / To Classify", "低", "Low", "เฮียตี๋5แสนแล้วนะหม่ามี๊", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
      ...
      country("ph", "菲律宾", "Philippines", "https://trends24.in/philippines/", [
        ...
        t("#PBBGen12Big4", "综合/待分类", "General / To Classify", "低", "Low", "PBBGen12Big4", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#LIFEgoesON", "综合/待分类", "General / To Classify", "低", "Low", "LIFEgoesON", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#BINI6thSingleShagidi", "综合/待分类", "General / To Classify", "低", "Low", "BINI6thSingleShagidi", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("GOD DID", "综合/待分类", "General / To Classify", "低", "Low", "GOD DID", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#HappyMarisDay", "综合/待分类", "General / To Classify", "低", "Low", "HappyMarisDay", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        ...
        t("#PusuanMoAko", "综合/待分类", "General / To Classify", "低", "Low", "PusuanMoAko", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Uninvited", "综合/待分类", "General / To Classify", "低", "Low", "Uninvited", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        ...
        t("#PBAFinals", "综合/待分类", "General / To Classify", "低", "Low", "PBAFinals", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""})
      ]),
      ...
      country("tr", "土耳其", "Turkey", "https://trends24.in/turkey/", [
        ...
        t("#Gazze", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "Gazze", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Fenerbahçe", "综合/待分类", "General / To Classify", "低", "Low", "Fenerbahçe", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Kudüs", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "Kudüs", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#GazzeKatliamdır", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "GazzeKatliamdır", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Galatasaray", "综合/待分类", "General / To Classify", "低", "Low", "Galatasaray", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        ...
        t("#LeMan", "综合/待分类", "General / To Classify", "低", "Low", "LeMan", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Külliye", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "Külliye", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#CHP", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "CHP", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#AKPARTİ", "综合/待分类", "General / To Classify", "政治/争议", "Political / Controversy", "AKPARTİ", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#nusaybin", "综合/待分类", "General / To Classify", "低", "Low", "nusaybin", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#TFF", "综合/待分类", "General / To Classify", "低", "Low", "TFF", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Beşiktaş", "综合/待分类", "General / To Classify", "低", "Low", "Beşiktaş", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Hindistan", "综合/待分类", "General / To Classify", "低", "Low", "Hindistan", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
      ...
      country("vn", "越南", "Vietnam", "https://getdaytrends.com/vietnam/", [
        t("#IfIRun", "综合/待分类", "General / To Classify", "低", "Low", "IfIRun", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Lemon8", "综合/待分类", "General / To Classify", "低", "Low", "Lemon8", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#feelgood", "品牌活动/消费", "Brand / Consumer", "低", "Low", "feelgood", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Mayday", "综合/待分类", "General / To Classify", "低", "Low", "Mayday", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#ABSCBNBall2026", "体育/赛事", "Sports / Event", "低", "Low", "ABSCBNBall2026", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#livelaughlove", "综合/待分类", "General / To Classify", "低", "Low", "livelaughlove", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#PBBGen12Big4", "综合/待分类", "General / To Classify", "低", "Low", "PBBGen12Big4", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#tinhyeu", "综合/待分类", "General / To Classify", "低", "Low", "tinhyeu", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#iheartawards", "颁奖礼/红毯/盛典", "Awards / Red Carpet / Ceremony", "低", "Low", "iheartawards", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#VivaVideo", "综合/待分类", "General / To Classify", "低", "Low", "VivaVideo", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#rose", "综合/待分类", "General / To Classify", "低", "Low", "rose", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Okto", "综合/待分类", "General / To Classify", "低", "Low", "Okto", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Minecraft", "综合/待分类", "General / To Classify", "低", "Low", "Minecraft", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Xbox", "综合/待分类", "General / To Classify", "低", "Low", "Xbox", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#capcut", "综合/待分类", "General / To Classify", "低", "Low", "capcut", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Spotify", "音乐/演出/发布", "Music / Show / Release", "低", "Low", "Spotify", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#TaylorSwift", "综合/待分类", "General / To Classify", "低", "Low", "TaylorSwift", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#MinecraftMovie", "综合/待分类", "General / To Classify", "低", "Low", "MinecraftMovie", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Movie", "综合/待分类", "General / To Classify", "低", "Low", "Movie", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""}),
        t("#Kiara", "综合/待分类", "General / To Classify", "低", "Low", "Kiara", {"threadsTop":[],"threadsRecent":[],"tiktokTop":[],"tiktokRecent":[],"verifiedAt":"","verifier":""})
      ])
    ],
    priorities: {
      zh: [
